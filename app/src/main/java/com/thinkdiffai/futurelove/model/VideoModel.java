...
public class VideoModel {
    ...
    public VideoModel(int id, int id_categories, int age_video, String name_categories, String detail, String chung_toc, String gioi_tinh, String link_video, String mau_da, String noi_dung, String thumbnail) {
        this.id = id;
