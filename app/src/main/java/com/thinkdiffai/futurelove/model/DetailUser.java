...
public class DetailUser {
    ...
    public DetailUser(int id_user, int count_comment, int count_sukien, int count_view, String device_register, String email, String ip_register, String link_avatar, String user_name) {
