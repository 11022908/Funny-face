...
public class Sukien2Image{
    ...
    public Sukien2Image(String id_saved, String link_src_goc, String link_tar_goc, String link_da_swap, String id_toan_bo_su_kien, String thoigian_sukien, String device_them_su_kien, String ip_them_su_kien, int id_user, int count_comment, int count_view, int id_template) {
